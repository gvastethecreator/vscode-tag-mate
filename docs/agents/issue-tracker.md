...
- Project number: `29`
- Project title: `Tag Mate`
- Project URL: https://github.com/users/gvastethecreator/projects/29
- Local root: `.scratch/vscode-tag-mate/`
...
- Spec: `.scratch/vscode-tag-mate/spec.md` (`PRD.md` remains compatible).
- Ticket mirrors: `.scratch/vscode-tag-mate/issues/<NN>-<slug>.md`. Never under `docs/`.
- Rejected requests: `.scratch/vscode-tag-mate/out-of-scope/<concept>.md`.
...
GitHub project: https://github.com/users/gvastethecreator/projects/29
...
5. Add the Issue to Project `29` under `gvastethecreator`.
...
```powershell
gh issue view <number> -R gvastethecreator/vscode-tag-mate --json number,title,state,body,labels,assignees,comments,updatedAt,url
gh project view 29 --owner gvastethecreator --format json
gh project field-list 29 --owner gvastethecreator --format json
gh project item-list 29 --owner gvastethecreator --limit 200 --format json --field Status
gh project item-add 29 --owner gvastethecreator --url <issue-url>
gh project item-edit 29 --owner gvastethecreator --url <issue-url> --field Status --value Todo
gh issue create -R gvastethecreator/vscode-tag-mate --title <title> --body-file <path> --parent <parent-number> --blocked-by <number,number>
gh issue edit <issue-number> -R gvastethecreator/vscode-tag-mate --parent <parent-number> --add-blocked-by <number>
```
